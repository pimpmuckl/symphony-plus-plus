...
function Write-Usage {
  ...
  Write-Host "  pwsh plugins/symphony-plus-plus-mcp/scripts/sympp-solo.ps1 plan|progress|finding --session-id <id> --summary <text> [--status <status>]"
  Write-Host "  pwsh plugins/symphony-plus-plus-mcp/scripts/sympp-solo.ps1 blocker --session-id <id> --summary <text> [--blocker-id <id>]"
  Write-Host "  pwsh plugins/symphony-plus-plus-mcp/scripts/sympp-solo.ps1 decision --session-id <id> --decision <text> [--rationale <text>] [--scope-impact <text>]"
  Write-Host "  pwsh plugins/symphony-plus-plus-mcp/scripts/sympp-solo.ps1 resolve-blocker --session-id <id> --blocker-id <id> --resolution <text>"
  Write-Host "  pwsh plugins/symphony-plus-plus-mcp/scripts/sympp-solo.ps1 validation --session-id <id> --summary <text> --result passed|failed|skipped|blocked|not_run [--command <command>]"
  Write-Host "  pwsh plugins/symphony-plus-plus-mcp/scripts/sympp-solo.ps1 show --session-id <id>"
  Write-Host "  pwsh plugins/symphony-plus-plus-mcp/scripts/sympp-solo.ps1 pause|resume|complete|archive --session-id <id>"
  Write-Host ""

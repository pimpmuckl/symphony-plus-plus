defmodule SymphonyElixir.SymphonyPlusPlus.CodexSkillPackageTest do
  ...
  test "enable command refuses nested inline-table enabled without config mutation" do
    powershell = System.find_executable("powershell.exe") || System.find_executable("pwsh") || System.find_executable("powershell")
    temp_codex_home = Path.join(System.tmp_dir!(), "sympp-plugin-enable-nested-inline-#{System.unique_integer([:positive])}")

defmodule Mix.Tasks.CodeQuality.Guard do
  ...
  @legacy_ratchets %{
    ...
    "test/symphony_elixir/symphony_plus_plus/dashboard_api_test.exs" => %{max_lines: 7508},
    ...
    "test/symphony_elixir/symphony_plus_plus/mcp/work_request_tools_02_test.exs" => %{max_lines: 1608},

...
Use `docs/00_ARCHITECT_AGENT_HANDOFF.md` as your operating contract. Sequence WorkPackages from the operator-approved phase scope and live Symphony++ state, dispatch worker agents, review their PRs, and merge them into the Symphony++ beta branch only when package acceptance criteria and tests pass.

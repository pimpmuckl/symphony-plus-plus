...
Point-in-time table extracted from `implementation_docs_symphplusplus/mcp/mcp_tools_contract.json` during the scout pass. The JSON contract remains the source of truth; use this snapshot to review the current surface alongside `ROADMAP.md`.
...
| `append_finding` | `bound_worker_tools`, `worker_tools` | `body`, `idempotency_key`, `title` | none | `id`, `severity`, `work_package_id` | infer/default |
| `append_progress` | `bound_worker_tools`, `worker_tools` | `idempotency_key`, `summary` | none | `body`, `payload`, `status`, `work_package_id` | infer/default |
| `set_status` | `bound_worker_tools`, `worker_tools` | `expected_status`, `status` | none | `reason`, `work_package_id` | infer/default |
| `report_blocker` | `bound_worker_tools`, `worker_tools` | `idempotency_key`, `summary` | none | `blocker_id`, `body`, `payload`, `status`, `work_package_id` | infer/default |
| `resolve_blocker` | `shared_worker_architect_tools`, `bound_worker_tools`, `bound_architect_tools`, `architect_tools`, `worker_tools` | `blocker_id`, `idempotency_key`, `resolution`, `summary` | none | `body`, `payload`, `status`, `work_package_id` | infer/default |
| `add_comment` | `shared_worker_architect_tools`, `bound_worker_tools`, `bound_architect_tools`, `architect_tools`, `worker_tools` | `body`, `target_id`, `target_kind` | none | `work_package_id` | infer/default |
| `list_comments` | `shared_worker_architect_tools`, `bound_worker_tools`, `bound_architect_tools`, `architect_tools`, `worker_tools` | `target_id`, `target_kind` | none | `work_package_id` | infer/default |
...
| `create_guidance_request` | `bound_worker_tools`, `worker_tools` | `context`, `idempotency_key`, `question`, `summary` | none | `work_package_id` | infer/default |
...
| `request_scope_expansion` | `bound_worker_tools`, `worker_tools` | `idempotency_key`, `summary` | none | `body`, `payload`, `status`, `work_package_id` | infer/default |
...
| `attach_pr` | `bound_worker_tools`, `worker_tools` | none | none | `body`, `head_sha`, `idempotency_key`, `metadata`, `number`, `payload`, `repository`, `status`, `summary`, `url`, `work_package_id` | infer/default |
...
| `submit_review_package` | `bound_worker_tools`, `worker_tools` | `artifacts`, `head_sha`, `summary`, `tests` | none | `acceptance_criteria_met`, `body`, `idempotency_key`, `payload`, `reviews`, `status`, `work_package_id` | infer/default |
